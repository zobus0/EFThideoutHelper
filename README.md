...
При первом запуске укажите текущие уровни модулей — изменить их можно в любой момент через **⚙ Уровни убежища**. Там же можно импортировать собранные предметы из буфера обмена (строки вида `предмет количество`; принимаются короткие и английские названия).
